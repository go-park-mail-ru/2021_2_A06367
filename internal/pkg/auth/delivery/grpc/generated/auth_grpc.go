...
// CheckByLogin mocks base method.
func (m *MockAuthServiceClient) CheckByLogin(ctx context.Context, in *LoginUser, opts ...grpc.CallOption) (*UserUUID, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "CheckByLogin", varargs...)
	ret0, _ := ret[0].(*UserUUID)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CheckByLogin indicates an expected call of CheckByLogin.
func (mr *MockAuthServiceClientMockRecorder) CheckByLogin(ctx, in interface{}, opts ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, in}, opts...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckByLogin", reflect.TypeOf((*MockAuthServiceClient)(nil).CheckByLogin), varargs...)
}
...
// CheckByLogin mocks base method.
func (m *MockAuthServiceServer) CheckByLogin(arg0 context.Context, arg1 *LoginUser) (*UserUUID, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CheckByLogin", arg0, arg1)
	ret0, _ := ret[0].(*UserUUID)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// CheckByLogin indicates an expected call of CheckByLogin.
func (mr *MockAuthServiceServerMockRecorder) CheckByLogin(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckByLogin", reflect.TypeOf((*MockAuthServiceServer)(nil).CheckByLogin), arg0, arg1)
}
