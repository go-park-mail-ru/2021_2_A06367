...
INSERT INTO films VALUES ('335b9fdd-64e9-4403-ba24-7269ca8a5a52', '{триллер,боевик}', 'США', '2003-01-01 03:00:00+03', 'Рекрут', 2003, '{"Роджер Дональдсон"}', '{"Роджер Таун","Курт Уиммер","Митч Глейзер"}', '{7d4e974a-2af6-4c41-b760-23225e8fef4c,7efcb4cc-77a0-4b99-8847-b30ac9c14fcb}', '2003-01-01', 115, 'Ru', '???', 16, '{rekrut.webp, rekrut-big.webp}', '{rekrut.mp4}', 'Джеймс Клэйтон - студент и опытный хакер. Он привлекает внимание спецслужб, и его вербуют в ЦРУ, упоминая таинственное исчезновение его отца в 90-х. Джеймс обучается у Уолтера Бёрка. Он отлично сдает все тесты, кроме последнего. Так он становится агентом без прикрытия и получает задание: найти «крота», который похищает опасный вирус из Лэнгли.', false, true, 'rekrut');
...
INSERT INTO films VALUES ('fbf17d95-f8bb-4ed7-b385-5111c321cbdc', '{триллер,драма,фантастика,боевик}', 'США', '2002-01-01 03:00:00+03', 'Эквилибриум', 2002, '{"Курт Уиммер"}', '{"Курт Уиммер"}', '{328db934-874e-4283-ab1d-1da4c12ea012,1f1df240-f513-40ed-acd1-fc8dbd3e8a4e}', '2002-01-01', 107, 'Ru', '???', 16, '{ekvilibrium.webp, ekvilibrium-big.webp}', '{ekvilibrium.mp4}', 'В будущем люди лишены возможности выражать эмоции. Это цена, которую человечество платит за устранение из своей жизни войны. Теперь книги, искусство и музыка находятся вне закона, а любое чувство — преступление, наказуемое смертью.
