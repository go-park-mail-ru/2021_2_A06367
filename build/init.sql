...
INSERT INTO films VALUES ('ddd73f7f-3ae7-467f-a79b-f3465485a8bf', '{комедия}', 'США', '2003-01-01 03:00:00+03', 'Тупой и еще тупее тупого: Когда Гарри встретил Ллойда', 2003, '{"Трой Миллер"}', '{"Питер Фаррелли","Беннетт Йеллин","Дэнни Байерс","Бобби Фаррелли","Роберт Бренер","Трой Миллер"}', '{94f31064-c88d-497a-b03a-f818768d408f,02f3dfcb-235a-4628-a4a1-2a3577109305}', '2003-01-01', 85, 'Ru', '100 млн', 16, '{dumb-and-dumber.webp}', '{tupoi-i-eshche-tupee-tupogo:-kogda-garri-vstretil-lloida.mp4}', 'Как же встретились два героя-недоумка Гарри и Ллойд, известные по фильму «Тупой и еще тупее»? Оба несколько лет не ходили в школу, а учились на дому. Пришло время отправляться в школу, и прямо на улице Гарри и Ллойд столкнулись лбами...
