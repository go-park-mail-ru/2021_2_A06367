...
INSERT INTO actors VALUES ('61ecb21e-64d9-11ec-90d6-0242ac120003', 'Колин', 'Фаррелл', '373.jpg', 176, '1976-06-31 00:00:00', 'Ирландский актёр кино и телевидения.', '{Триллер,Боевики}');
...
INSERT INTO films VALUES ('3100072a-e1e5-44c6-9a10-77be314dd492', '{Триллер,Детективы}', 'США', '2002-11-05 03:00:00+03', 'Телефонная будка', 2002, '{"Джоэл Шумахер"}', '{"Ларри Коэн"}', '{61ecb21e-64d9-11ec-90d6-0242ac120003, 72dd2b7d-f90b-492b-bfa9-42dd63cc86f9}', '2002-11-14', 97, 'Ru', '100 млн', 16, '{telefonnaia-budka.webp, telefonnaia-budka-big.webp}', '{telefonnaia-budka.mp4}', 'Один телефонный звонок может изменить всю жизнь человека или даже оборвать ее. Герой фильма Стью Шеферд становится пленником телефонной будки.
...
INSERT INTO films VALUES ('335b9fdd-64e9-4403-ba24-7269ca8a5a52', '{Триллер,Боевики}', 'США', '2003-01-01 03:00:00+03', 'Рекрут', 2003, '{"Роджер Дональдсон"}', '{"Роджер Таун"," Курт Уиммер"," Митч Глейзер"}', '{7d4e974a-2af6-4c41-b760-23225e8fef4c, 61ecb21e-64d9-11ec-90d6-0242ac120003}', '2003-01-01', 115, 'Ru', '50 млн', 16, '{rekrut.webp, rekrut-big.webp}', '{rekrut.mp4}', 'Джеймс Клэйтон - студент и опытный хакер. Он привлекает внимание спецслужб, и его вербуют в ЦРУ, упоминая таинственное исчезновение его отца в 90-х. Джеймс обучается у Уолтера Бёрка. Он отлично сдает все тесты, кроме последнего. Так он становится агентом без прикрытия и получает задание: найти «крота», который похищает опасный вирус из Лэнгли.', false, false, 'rekrut');
