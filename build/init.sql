...
INSERT INTO films VALUES ('9d574931-e719-44fc-bad2-69a1de36d00e', '{фантастика,боевик}', 'США', '1999-01-01 03:00:00+03', 'Матрица', 1999, '{"Лана Вачовски","Лилли Вачовски"}', '{"Лилли Вачовски","Лана Вачовски"}', '{ffb54b75-adb4-4cf2-adb0-8ad1ae223d45,e5717e55-d822-461a-bca1-a19764d59a06}', '1999-01-01', 136, 'Ru', '120 млн', 16, '{matrix.webp}', '{matritsa.mp4}', 'Жизнь Томаса Андерсона разделена на две части: днём он — самый обычный офисный работник, получающий нагоняи от начальства, а ночью превращается в хакера по имени Нео, и нет места в сети, куда он бы не смог проникнуть. Но однажды всё меняется. Томас узнаёт ужасающую правду о реальности.', false, false, 'matrix');
INSERT INTO films VALUES ('f0285cb7-d7c7-48d7-b94a-1bdf62469553', '{драма,детектив,приключения,комедия,семейный}', 'США', '2003-01-01 03:00:00+03', 'Клад', 2003, '{"Эндрю Дэвис"}', '{"Луис Сачар"}', '{0d4b2616-f636-4457-9e21-4ffe7b828149,313598fb-6eae-4cb7-9629-ccf10aea89f4}', '2003-01-01', 117, 'Ru', '???', 12, '{klad.webp}', '{klad.mp4}', 'Стэнли арестован по ложному обвинению в краже кроссовок и отправлен в трудовой лагерь, расположенный в техасской пустыне. Воспитатели «закаляют характер» подростков странным наказанием. Ребята копают ямы в иссушенной земле, но не знают, что их на самом деле используют для раскопок таинственного клада. Однако Стэнли удается раскрыть загадочную связь между сокровищами и проклятием, тяготеющим долгие годы над его семьей…', false, false, 'klad');
INSERT INTO films VALUES ('c8ae08e9-ee3d-4b59-9bdf-af456de7f97a', '{мелодрама,комедия}', 'США', '2003-01-01 03:00:00+03', 'Управление гневом', 2003, '{"Питер Сигал"}', '{"Дэвид Дорфман"}', '{a6909e2d-8fc8-43f0-ad7f-e0ae11c75964,942a7956-e666-4ab9-a6b9-1616c8092fe1}', '2003-01-01', 106, 'Ru', '???', 12, '{upravlenie-gnevom.webp}', '{upravlenie-gnevom.mp4}', 'Скромному клерку отчаянно не везет. Парня по обвинению в нападении на бортпроводницу приговаривают к лечению у психиатра. Но верно говорят, что большинство психиатров сами немного безумны. Или сильно не в себе...', false, true, 'upravlenie-gnevom');
INSERT INTO films VALUES ('3100072a-e1e5-44c6-9a10-77be314dd492', '{триллер,криминал}', 'США', '2002-01-01 03:00:00+03', 'Телефонная будка', 2002, '{"Джоэл Шумахер"}', '{"Ларри Коэн"}', '{2704d03b-bfa9-42e2-9895-2144809d39de,72dd2b7d-f90b-492b-bfa9-42dd63cc86f9}', '2002-01-01', 81, 'Ru', '???', 16, '{telefonnaia-budka.webp}', '{telefonnaia-budka.mp4}', 'Один телефонный звонок может изменить всю жизнь человека или даже оборвать ее. Герой фильма Стью Шеферд становится пленником телефонной будки.
...
INSERT INTO films VALUES ('335b9fdd-64e9-4403-ba24-7269ca8a5a52', '{триллер,боевик}', 'США', '2003-01-01 03:00:00+03', 'Рекрут', 2003, '{"Роджер Дональдсон"}', '{"Роджер Таун","Курт Уиммер","Митч Глейзер"}', '{7d4e974a-2af6-4c41-b760-23225e8fef4c,7efcb4cc-77a0-4b99-8847-b30ac9c14fcb}', '2003-01-01', 115, 'Ru', '???', 16, '{rekrut.webp}', '{rekrut.mp4}', 'Джеймс Клэйтон - студент и опытный хакер. Он привлекает внимание спецслужб, и его вербуют в ЦРУ, упоминая таинственное исчезновение его отца в 90-х. Джеймс обучается у Уолтера Бёрка. Он отлично сдает все тесты, кроме последнего. Так он становится агентом без прикрытия и получает задание: найти «крота», который похищает опасный вирус из Лэнгли.', false, true, 'rekrut');
...
INSERT INTO films VALUES ('fbf17d95-f8bb-4ed7-b385-5111c321cbdc', '{триллер,драма,фантастика,боевик}', 'США', '2002-01-01 03:00:00+03', 'Эквилибриум', 2002, '{"Курт Уиммер"}', '{"Курт Уиммер"}', '{328db934-874e-4283-ab1d-1da4c12ea012,1f1df240-f513-40ed-acd1-fc8dbd3e8a4e}', '2002-01-01', 107, 'Ru', '???', 16, '{ekvilibrium.webp}', '{ekvilibrium.mp4}', 'В будущем люди лишены возможности выражать эмоции. Это цена, которую человечество платит за устранение из своей жизни войны. Теперь книги, искусство и музыка находятся вне закона, а любое чувство — преступление, наказуемое смертью.
